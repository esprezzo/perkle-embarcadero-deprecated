...
Mining on the public Perkle network is best done using GPUs, requiring
an OpenCL or CUDA enabled `ethminer` instance. For information on such a setup, please consult the
[EtherMining subreddit](https://www.reddit.com/r/EtherMining/) and the [Genoil miner](https://github.com/Genoil/cpp-ethereum)
repository.

However, currently CPU mining is still feasible until the hashrate increases. To start a Perkle
instance for mining, run it with all your usual flags, extended by:

```
$ perkle <usual-flags> --mine --minerthreads=YOUR_CPU_COUNT( eg: 8) --etherbase=YOUR_PRKL_ADDRESS (eg: 0x0000000000000000000000000000000000000000)
```
...
## > personal.
```
ersonal._requestManager personal.getListWallets  personal.newAccount      
...
### Full node on the main Perkle network
